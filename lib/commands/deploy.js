...
const deployFunction = async ({ functionId, all, yes } = {}) => {
    ...
    if (functionId) {
        ...
        checkDeployConditions(functions, localConfig, "function");
...
const deployCollection = async ({ all, yes } = {}) => {
    ...
    if (all) {
        checkDeployConditions(localConfig.getCollections(), localConfig, "collection");
...
const deployBucket = async ({ all, yes } = {}) => {
    ...
    if (all) {
        checkDeployConditions(configBuckets, localConfig, "bucket");
...
const deployTeam = async ({ all, yes } = {}) => {
    ...
    if (all) {
        checkDeployConditions(configTeams, localConfig, "team");
